            ...
            <div className="col-lg-6">
              <div className="card-body p-md-5 mx-md-4">
                ...
                <div className="text-center">
                  ...
                  <h4 className="mt-1 mb-3 pb-1">Welcome To BOB OEC-7</h4>
                  <h5 className="mt-1 mb-3 pb-1">Student Practice Portal</h5>
                </div>
                ...
                <form>
                  ...
                  <div data-mdb-input-init className="form-outline mb-4">
                    ...
                    <label className="form-label" forindex="form2Example11">Username</label>
                  </div>

                  <div data-mdb-input-init className="form-outline mb-4">
                    <input type="password" id="form2Example22" className="form-control" />
                    <label className="form-label" forindex="form2Example22">Password</label>
                  </div>
